...
def test_book():
    for num_sims in range(1):
        for num_runs in range(100):
            sys = SystemBook(num_init_fundamentalists=1000, num_init_speculators=1000, init_upward_market_dir=True, 
                            num_trade_cycles=10, chg_num_agent_pcycle=100, cycle_cool_off_per_dilution=1, 
